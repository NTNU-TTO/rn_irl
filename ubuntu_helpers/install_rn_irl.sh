...
ln -sf /etc/rn_irl/bin/rn_irl/ubuntu_helpers/rn_irl_staging.sh /bin/rn_irl_staging
ln -sf /etc/rn_irl/bin/rn_irl/ubuntu_helpers/rn_irl_staging_env.sh /bin/rn_irl_staging_env
ln -sf /etc/rn_irl/bin/rn_irl/ubuntu_helpers/rn_irl_staging2prod.sh /bin/rn_irl_staging2prod
